...
class DataTransformationConfig:
    def __init__(self, training_pipeline_cofig: TrainingPipelineconfig):
        self.data_transformation_dir : str = os.path.join(training_pipeline_cofig.artifact_dir, training_pipeline.DATA_TRANSFORMATION_DIR_NAME)
        ...
        self.transformed_test_file_path: str = os.path.join(self.data_transformation_dir, training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_DIR_NAME, training_pipeline.TEST_FILE_NAME.replace("csv", "npy"))
        self.transformed_object_file_path: str = os.path.join(self.data_transformation_dir, training_pipeline.PREPROCESSING_OBJECT_FILE_NAME, training_pipeline.PREPROCESSING_OBJECT_FILE_NAME)
